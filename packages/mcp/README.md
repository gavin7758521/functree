...
- `functree_upsert_feature_set`: create or update a feature set under a project.
- `functree_upsert_feature`: create or update a feature under a feature set.
- `functree_create_alignment`: create or update a cross-level alignment relation.
- `functree_query_context`: read project, feature set, feature, and alignment context.
